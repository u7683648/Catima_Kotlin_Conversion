...
/**
 * The old {@link ManageGroupActivity} class, written in Java. This class
 * will be translated to Kotlin as part of Issue XXXXX. This copy is left here
 * as reference, and is to be deleted before the PR is created.
 */
public class __ManageGroupActivity extends CatimaAppCompatActivity implements ManageGroupCursorAdapter.CardAdapterListener {
    ...
    private void leaveWithoutSaving() {
        if (hasChanged()) {
            AlertDialog.Builder builder = new MaterialAlertDialogBuilder(__ManageGroupActivity.this);
